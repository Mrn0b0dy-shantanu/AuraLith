...
const sections = [
  {
    ...
    icon: Book,
    description:
      "Understand the deterministic architecture and latency optimization strategies.",
    links: [
  ...
  },
  {
    ...
    icon: Code2,
    description:
      "Complete documentation for REST, gRPC, and WebSocket endpoints.",
  ...
  },
  {
    ...
    icon: Cpu,
    description:
      "Guides for deploying on bare-metal and maximizing GPU utilization.",
  ...
  },
  {
    ...
    icon: Network,
    description:
      "Configuring VPC peering, private links, and multi-region failover.",
        ...
        <SystemContainer label="SYS.DOCS.01">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/60 font-mono leading-relaxed max-w-2xl mx-auto text-center">
              [ Everything you need to integrate, optimize, and scale your
              infrastructure on AuraLith. ]
            </p>
          </motion.div>
        </SystemContainer>
            ...
            <div className="sticky top-32 mt-8">
              ...
              <div className="bg-[#111] border border-white/10 rounded-none overflow-hidden group">
                <div className="flex items-center px-4 py-2 border-b border-white/10 bg-[#0a0a0a]">
                  <div className="text-xs font-mono text-[#22c55e] uppercase tracking-widest">
                    bash
                  </div>
                </div>
                <div className="p-6 font-mono text-sm relative">
                  ...
                  <div className="text-white/40 mt-6 mb-2">
                    # Initialize client
                  </div>
                  ...
                  <div className="mt-2 text-white/80">
                    <span className="text-[#8b5cf6]">const</span> client ={" "}
                    <span className="text-[#8b5cf6]">new</span> AuraClient({"{"}
                  </div>
              ...
              {sections.map((section, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-xl font-sans font-medium mb-3 tracking-tight uppercase">
                      {section.title}
                    </h3>
                    ...
                    <ul className="space-y-3 relative z-10">
                      {section.links.map((link, i) => (
                        <li key={i}>
                          <a
                            href="#"
                            className="text-xs font-mono text-white/70 hover:text-[#22c55e] flex items-center gap-2 group/link transition-colors"
                          >
                            <span className="text-white/20 group-hover/link:text-[#22c55e]">
                              &gt;
                            </span>
                            {link}
                          </a>
